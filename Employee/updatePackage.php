...
<body >
    <div class="back-vid">
        ...
        <div class="content" >
            ...
            <form  action="updatePackage.php" method="POST" enctype="multipart/form-data">
                ...
                <h1 style="text-align:center;align-items:center;">update the Package</h1>
    ...
    <?php
        ...
        if(!empty($_POST) && $_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $upload_dir = "../package/uploads/";
            $path = $upload_dir.$Logo_name;       
           
            $query = "UPDATE package_tbl SET destination=\"".$destination."\",title=\"".$title."\",price=\"".$price."\",details=\"".$details."\",Logo_name=\"".$Logo_name."\" WHERE package_id=\"".$packageId."\"";
