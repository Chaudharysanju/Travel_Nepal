		...
		<table>
			...
			<tr>
                ...
                <td><?php
                    ...
                    echo "<a href='http://localhost/smart travel/Employee/updateDestination1.php?Destination=$Destination'>UPDATE</a>";
                    ?>
                </td>
                <td><?php
                    
                    echo "<a href='http://localhost/smart travel/Employee/deleteDestination.php?Destination=$Destination'>DELETE</a>";
                    ?>
                </td>
