...
<body>
    ...
    $_SESSION['packageId']=$row['package_id'];
    ...
    $package_id=$row["package_id"];
                ...
                echo "<div class='minor_details'>
                        ...
                        <form  action=\"http://localhost/smart travel/package/book_form.php\" method=\"POST\" enctype=\"multipart/form-data\">
                          <input type=\"radio\" style =\"display :none\" name=\"package_id\" value=\"".$package_id."\" checked>
                          <button type=\"submit\" name=\"submit1\" class=\"btn\" formaction=\"http://localhost/smart travel/package/BookingForm.php\">BOOK</button>
                        </form>
 ...
 ?>
    ...
    <div class="login-form-container">
        ...
        <div id="login">
        <form action="http://localhost/smart travel/package/userCheck.php" method="POST">
    ...
    <div class="signup-form-container">
        ...
        <div id="signup">
        <form action="http://localhost/smart travel/package/signIn.php" method="POST">
            <h3>signup</h3>
