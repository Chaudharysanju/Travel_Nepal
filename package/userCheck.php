<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        if (mysqli_num_rows($login) == 1) {
            ...
            // Jump to review page
            header("Location: http://localhost/smart travel/package/review.php");
        }
        // credential didnot matched
        else {

            
            echo "<h2>Login credentials was not found in database </h2>  <a href=\"http://localhost/smart travel/index.html\">   HOME</a>";
