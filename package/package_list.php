    ...
    <div class="back-vid">
        ...
        <?php
            ...
            if (mysqli_num_rows($run) > 0){
                echo"<form action=\"http://smart travel/package/fetch.php\"  method=\"POST\" enctype=\"multipart/form-data\">";
                while($row = mysqli_fetch_array($run)) {
                        ...
                        <div class=\"box-container\">
                            ...
                            <img src=\"uploads/$row[Logo_name]\"   frameborder='0' alt=\"Unable to see photo\">
                                <div class=\"content\">
                                    ...
                                    <button type=\"submit\" name=\"destination\" class=\"btn\" formaction=\"http://smart travel/package/fetch.php\"><input type=\"radio\" name=\"packageId\" value=\"".$package_id."\"  >see more</button>
                                </div>
                            </div>
                    ...
                    echo "<a href=\" http://smart travel/index.html\" style =\"background-color: orange;border-radius:20px;padding:4px;text-decoration: none\"> GO home</a>";
