...
let bookhistoryBtn = document.querySelector('#bookhistory-btn');
let bookhistoryForm = document.querySelector('.bookhistory');
...
bookhistoryBtn.addEventListener('click', () =>{  
    bookhistoryForm.classList.add('active');    //to show login form while clicking login/admin/form button
});
...
formClose1.addEventListener('click', () =>{
    bookhistoryForm.classList.remove('active'); //to close login form when clicking "X" logo
});
